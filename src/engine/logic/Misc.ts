 ...
 * @returns {string}
 */
function getStr(text:Function|string,engineRef:RenderEngine|undefined):string{
  try {
...
export {mobileCheck,wrapText,random,lambdaConverter,getStr,degToRad,rad2Deg,getAttribs,arrayFlatter, sortByReference}